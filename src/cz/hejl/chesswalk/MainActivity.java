...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View v) {
				if (settings.getBoolean(Common.PREF_LOGIN_AUTOMATICALLY, true)
					...
					if (settings.getBoolean(Common.PREF_LOGIN_GUEST, false)) {
						showLoggingInDialog();
						loginTask = new LoginTask(MainActivity.this, dgLoggingIn, tvLoggingState).execute(
								"guest", "");
					} else {
						showLoggingInDialog();
						loginTask = new LoginTask(MainActivity.this, dgLoggingIn, tvLoggingState).execute(
								settings.getString(Common.PREF_LOGIN_USERNAME, ""), settings.getString(
		...
		if (savedInstanceState != null
			...
			if (settings.getBoolean(Common.PREF_LOGIN_GUEST, false)) {
				showLoggingInDialog();
				loginTask = new LoginTask(MainActivity.this, dgLoggingIn, tvLoggingState)
						.execute("guest", "");
			} else {
				showLoggingInDialog();
				loginTask = new LoginTask(MainActivity.this, dgLoggingIn, tvLoggingState).execute(settings
						.getString(Common.PREF_LOGIN_USERNAME, ""), settings.getString(
						Common.PREF_LOGIN_PASSWORD, ""));
			}
		}
	}
	...
	private void showLoggingInDialog() {
		...
		tvLoggingState = (TextView) dgLoggingIn.findViewById(R.id.tvLoggingInState);
