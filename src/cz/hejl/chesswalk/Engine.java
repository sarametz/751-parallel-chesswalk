...
//####[271]####
    public Move bestMove(String FEN, int depth, int time, boolean verbose) {//####[271]####
        ...
        Log.d("ENGINE", "Depth = " + currentDepth + " , Nodes = " + nodeCounter);//####[319]####
        return bestLine.get(0);//####[320]####
    }//####[321]####
//####[325]####
    private void updateBestLine(ArrayList<Move> line, int depth, int eval) {//####[325]####
